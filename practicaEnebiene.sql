...
(6, 'Sega', 'Japó', 'sega.png', 'Creadors de Sonic'),
(7, 'Capcom', 'Japó', 'capcom.png', 'Resident Evil i Street Fighter'),
(8, 'Square Enix', 'Japó', 'square.png', 'Final Fantasy i Kingdom Hearts'),
(9, 'Konami', 'Japó', 'konami.png', 'Metal Gear i Silent Hill'),
(10, 'Bandai Namco', 'Japó', 'bandai.png', 'Pac-Man i Tekken'),
(11, 'Activision', 'EUA', 'activision.png', 'Call of Duty'),
(12, 'Blizzard', 'EUA', 'blizzard.png', 'World of Warcraft'),
(13, 'Bethesda', 'EUA', 'bethesda.png', 'Skyrim i Fallout'),
(14, 'Valve', 'EUA', 'valve.png', 'Half-Life i Steam'),
(15, 'Epic Games', 'EUA', 'epic.png', 'Fortnite i Unreal'),
(16, 'BioWare', 'Canadà', 'bioware.png', 'Mass Effect'),
(17, 'CD Projekt Red', 'Polònia', 'cdprojekt.png', 'The Witcher i Cyberpunk'),
(18, 'FromSoftware', 'Japó', 'fromsoftware.png', 'Dark Souls i Elden Ring'),
(19, 'Insomniac Games', 'EUA', 'insomniac.png', 'Spider-Man i Ratchet'),
(20, 'Naughty Dog', 'EUA', 'naughtydog.png', 'The Last of Us'),
(21, 'Santa Monica Studio', 'EUA', 'santamonica.png', 'God of War'),
(22, 'PlatinumGames', 'Japó', 'platinum.png', 'Bayonetta'),
(23, 'Team Cherry', 'Austràlia', 'teamcherry.png', 'Hollow Knight'),
(24, 'Mojang', 'Suècia', 'mojang.png', 'Minecraft'),
(25, 'Supergiant Games', 'EUA', 'supergiant.png', 'Hades'),
(26, 'Rare', 'Regne Unit', 'rare.png', 'Sea of Thieves'),
(27, 'Obsidian', 'EUA', 'obsidian.png', 'Fallout New Vegas'),
(28, 'id Software', 'EUA', 'idsoftware.png', 'DOOM'),
(29, 'Arkane Studios', 'França', 'arkane.png', 'Dishonored'),
(30, 'Remedy Entertainment', 'Finlàndia', 'remedy.png', 'Alan Wake'),
(31, 'Techland', 'Polònia', 'techland.png', 'Dying Light'),
(32, 'Guerrilla Games', 'Països Baixos', 'guerrilla.png', 'Horizon Zero Dawn'),
(33, 'Sucker Punch', 'EUA', 'suckerpunch.png', 'Ghost of Tsushima'),
(34, 'Quantic Dream', 'França', 'quantic.png', 'Detroit Become Human'),
(35, 'Telltale Games', 'EUA', 'telltale.png', 'The Walking Dead'),
(36, 'Media Molecule', 'Regne Unit', 'mediamolecule.png', 'LittleBigPlanet'),
(37, 'Polyphony Digital', 'Japó', 'polyphony.png', 'Gran Turismo'),
(38, 'Warner Bros Games', 'EUA', 'wb.png', 'Batman Arkham'),
(39, 'Gearbox Software', 'EUA', 'gearbox.png', 'Borderlands'),
(40, 'Crytek', 'Alemanya', 'crytek.png', 'Crysis'),
(41, 'Creative Assembly', 'Regne Unit', 'creative.png', 'Total War'),
(42, 'Paradox Interactive', 'Suècia', 'paradox.png', 'Stellaris'),
(43, 'Hello Games', 'Regne Unit', 'hello.png', 'No Mans Sky'),
(44, 'Kojima Productions', 'Japó', 'kojima.png', 'Death Stranding'),
(45, 'Devolver Digital', 'EUA', 'devolver.png', 'Hotline Miami'),
(46, 'Playdead', 'Dinamarca', 'playdead.png', 'Limbo'),
(47, 'Team17', 'Regne Unit', 'team17.png', 'Worms'),
(48, 'Riot Games', 'EUA', 'riot.png', 'League of Legends'),
(49, 'Bungie', 'EUA', 'bungie.png', 'Halo i Destiny'),
(50, 'Respawn Entertainment', 'EUA', 'respawn.png', 'Apex Legends');
